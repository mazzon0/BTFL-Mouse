/**
 * @file pmw3389_srom.c
 * @brief PMW3389 SROM Firmware Data
 * 
 * This file contains the firmware data for the PMW3389 optical sensor.
 * The firmware must be uploaded to the sensor's SROM during initialization
 ...
 * 
 * @note This firmware is the property of PixArt Imaging Inc.
 * 
 * @author Ilaria
 * @date 2025-12-12
 */
 ...
 * @brief PMW3389 SROM firmware data
 * 
 * Complete firmware array (4094 bytes) for the PMW3389 optical sensor.
 * This data is uploaded to the sensor's SROM via SPI burst mode during
 * initialization.
 */
const uint8_t pmw3389_srom_data[PMW3389_SROM_LENGTH] = {
